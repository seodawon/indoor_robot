...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        super().__init__()
        w = str(weights[0] if isinstance(weights, list) else weights) # /home/ikhw/yolov5-ros2/build/yolov5/build/lib/yolov5/yolov5n.pt

        pt, jit, onnx, xml, engine, coreml, saved_model, pb, tflite, edgetpu, tfjs, paddle, triton = self._model_type(w) # true, ~ false
        fp16 &= pt or jit or onnx or engine or triton  # FP16
        nhwc = coreml or saved_model or pb or tflite or edgetpu  # BHWC formats (vs torch BCWH)
        stride = 16  # default stride
        ...
        if pt:  # PyTorch
            ...
            stride = max(int(model.stride.max()), 16)  # model stride 32 고정
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from yolov5.models.export import export_formats
